---
title: "Using ggpca for Publication-Ready Dimensionality Reduction Plots"
author: "Yaoxiang Li"
date: "2016-10-25"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using ggpca for Publication-Ready Dimensionality Reduction Plots}
...
This vignette demonstrates the use of the `ggpca` package for creating dimensionality reduction plots, including PCA, t-SNE, and UMAP. It showcases how to customize labels, titles, and density plots, providing publication-ready plots.

## Examples using the Iris Dataset

The following examples use the well-known Iris dataset to illustrate various plot configurations with the `ggpca` function.

```{r iris-examples, fig.width=7, fig.height=6}
...
## Examples using the Example Dataset

```{r example-data, fig.width=7, fig.height=6}
